...
export const SOURCES = [
  ...
  },
  {
    ...
    // its connection can be dropped after every check like seeip.org's. With
    // three fresh witnesses a partial round can reach a majority on its own
    // instead of waiting for the next full round when two of them disagree.
    http1: true,
    parse: (d) => ({ ip: d.ip, cc: d.cc }),
  },
];
